...
class FlickrHelper: NSObject {
    ...
    class func URLForSearchString(searchString: String) -> String {
        ...
        let url = "https://api.flickr.com/services/rest?api_key=\(apiKEY)&method=flickr.photos.search&tags=\(search)&format=json&nojsoncallback=true&extras=media&extras=url_sq&extras=url_m&per_page=20&page=1"
